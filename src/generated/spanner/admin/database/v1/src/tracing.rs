    ...
    T: super::stub::DatabaseAdmin + std::fmt::Debug + Send + Sync,
{
    ...
    async fn update_database_ddl(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            ...
            self.inner.update_database_ddl(req.clone(), options.clone()));
    ...
    async fn drop_database(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            ...
            self.inner.drop_database(req.clone(), options.clone()));
    ...
    async fn get_database_ddl(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            ...
            self.inner.get_database_ddl(req.clone(), options.clone()));
    ...
    async fn list_database_operations(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            ...
            self.inner.list_database_operations(req.clone(), options.clone()));
    ...
    async fn list_backup_operations(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            ...
            self.inner.list_backup_operations(req.clone(), options.clone()));
    ...
    async fn list_database_roles(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            ...
            self.inner.list_database_roles(req.clone(), options.clone()));
    ...
    async fn add_split_points(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            ...
            self.inner.add_split_points(req.clone(), options.clone()));
