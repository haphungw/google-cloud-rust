...
pub mod metrics_scopes {
    ...
    impl CreateMonitoredProject {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::MonitoredProject, crate::model::OperationMetadata>
        {
            ...
            let span = ::tracing::info_span!(
                "client::MetricsScopes::create_monitored_project.Wait",
                "gcp.rpc.method" = "client::MetricsScopes::create_monitored_project.Wait",
    ...
    impl DeleteMonitoredProject {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            let span = ::tracing::info_span!(
                "client::MetricsScopes::delete_monitored_project.Wait",
                "gcp.rpc.method" = "client::MetricsScopes::delete_monitored_project.Wait",
                "gcp.longrunning.operation_name" = ::tracing::field::Empty
            );
