...
pub mod app_connectors_service {
    ...
    impl CreateAppConnector {
        ...
        > {
            ...
            let span = ::tracing::info_span!(
                "client::AppConnectorsService::create_app_connector.Wait",
                "gcp.rpc.method" = "client::AppConnectorsService::create_app_connector.Wait",
    ...
    impl UpdateAppConnector {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            let span = ::tracing::info_span!(
                "client::AppConnectorsService::update_app_connector.Wait",
                "gcp.rpc.method" = "client::AppConnectorsService::update_app_connector.Wait",
                "gcp.longrunning.operation_name" = ::tracing::field::Empty
            );
    ...
    impl DeleteAppConnector {
        ...
        ) -> impl google_cloud_lro::Poller<(), crate::model::AppConnectorOperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            let span = ::tracing::info_span!(
                "client::AppConnectorsService::delete_app_connector.Wait",
                "gcp.rpc.method" = "client::AppConnectorsService::delete_app_connector.Wait",
                "gcp.longrunning.operation_name" = ::tracing::field::Empty
            );
    ...
    impl ReportStatus {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            let span = ::tracing::info_span!(
                "client::AppConnectorsService::report_status.Wait",
                "gcp.rpc.method" = "client::AppConnectorsService::report_status.Wait",
                "gcp.longrunning.operation_name" = ::tracing::field::Empty
            );
