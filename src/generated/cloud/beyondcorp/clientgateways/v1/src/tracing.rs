    ...
    T: super::stub::ClientGatewaysService + std::fmt::Debug + Send + Sync,
{
    async fn list_client_gateways(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            ...
            self.inner.list_client_gateways(req.clone(), options.clone()));
    ...
    async fn get_client_gateway(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            ...
            self.inner.get_client_gateway(req.clone(), options.clone()));
    ...
    async fn create_client_gateway(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            ...
            self.inner.create_client_gateway(req.clone(), options.clone()));
    ...
    async fn delete_client_gateway(
        ...
        let (_span, pending) = gaxi::client_request_signals!(
            ...
            self.inner.delete_client_gateway(req.clone(), options.clone()));
