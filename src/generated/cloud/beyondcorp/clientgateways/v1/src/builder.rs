...
pub mod client_gateways_service {
    ...
    impl CreateClientGateway {
        ...
        > {
            ...
            let span = ::tracing::info_span!(
                "client::ClientGatewaysService::create_client_gateway.Wait",
                "gcp.rpc.method" = "client::ClientGatewaysService::create_client_gateway.Wait",
    ...
    impl DeleteClientGateway {
        ...
        ) -> impl google_cloud_lro::Poller<(), crate::model::ClientGatewayOperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            let span = ::tracing::info_span!(
                "client::ClientGatewaysService::delete_client_gateway.Wait",
                "gcp.rpc.method" = "client::ClientGatewaysService::delete_client_gateway.Wait",
                "gcp.longrunning.operation_name" = ::tracing::field::Empty
            );
