...
pub mod environments {
    ...
    impl DeleteEnvironment {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            let span = ::tracing::info_span!(
                "client::Environments::delete_environment.Wait",
                "gcp.rpc.method" = "client::Environments::delete_environment.Wait",
                "gcp.longrunning.operation_name" = ::tracing::field::Empty
            );
    ...
    impl CheckUpgrade {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            let span = ::tracing::info_span!(
                "client::Environments::check_upgrade.Wait",
                "gcp.rpc.method" = "client::Environments::check_upgrade.Wait",
                "gcp.longrunning.operation_name" = ::tracing::field::Empty
            );
    ...
    impl SaveSnapshot {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            let span = ::tracing::info_span!(
                "client::Environments::save_snapshot.Wait",
                "gcp.rpc.method" = "client::Environments::save_snapshot.Wait",
                "gcp.longrunning.operation_name" = ::tracing::field::Empty
            );
    ...
    impl LoadSnapshot {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            let span = ::tracing::info_span!(
                "client::Environments::load_snapshot.Wait",
                "gcp.rpc.method" = "client::Environments::load_snapshot.Wait",
                "gcp.longrunning.operation_name" = ::tracing::field::Empty
            );
    ...
    impl DatabaseFailover {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            let span = ::tracing::info_span!(
                "client::Environments::database_failover.Wait",
                "gcp.rpc.method" = "client::Environments::database_failover.Wait",
                "gcp.longrunning.operation_name" = ::tracing::field::Empty
            );
