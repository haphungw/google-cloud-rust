...
pub mod vpc_access_service {
    ...
    impl CreateConnector {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Connector, crate::model::OperationMetadata>
        {
            ...
            let span = ::tracing::info_span!(
                "client::VpcAccessService::create_connector.Wait",
                "gcp.rpc.method" = "client::VpcAccessService::create_connector.Wait",
    ...
    impl DeleteConnector {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            let span = ::tracing::info_span!(
                "client::VpcAccessService::delete_connector.Wait",
                "gcp.rpc.method" = "client::VpcAccessService::delete_connector.Wait",
                "gcp.longrunning.operation_name" = ::tracing::field::Empty
            );
