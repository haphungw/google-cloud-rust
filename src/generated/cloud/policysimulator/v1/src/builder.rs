    ...
    impl CreateOrgPolicyViolationsPreview {
        ...
        > {
            ...
            let span = ::tracing::info_span!(
                "client::OrgPolicyViolationsPreviewService::create_org_policy_violations_preview.Wait",
                "gcp.rpc.method" = "client::OrgPolicyViolationsPreviewService::create_org_policy_violations_preview.Wait",
...
pub mod simulator {
    ...
    impl CreateReplay {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Replay, crate::model::ReplayOperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            let span = ::tracing::info_span!(
                "client::Simulator::create_replay.Wait",
                "gcp.rpc.method" = "client::Simulator::create_replay.Wait",
                "gcp.longrunning.operation_name" = ::tracing::field::Empty
            );
