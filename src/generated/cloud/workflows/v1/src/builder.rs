...
pub mod workflows {
    ...
    impl CreateWorkflow {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Workflow, crate::model::OperationMetadata>
        {
            ...
            let span = ::tracing::info_span!(
                "client::Workflows::create_workflow.Wait",
                "gcp.rpc.method" = "client::Workflows::create_workflow.Wait",
    ...
    impl DeleteWorkflow {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::OperationMetadata> {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            let span = ::tracing::info_span!(
                "client::Workflows::delete_workflow.Wait",
                "gcp.rpc.method" = "client::Workflows::delete_workflow.Wait",
                "gcp.longrunning.operation_name" = ::tracing::field::Empty
            );
    ...
    impl UpdateWorkflow {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::Workflow, crate::model::OperationMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            let span = ::tracing::info_span!(
                "client::Workflows::update_workflow.Wait",
                "gcp.rpc.method" = "client::Workflows::update_workflow.Wait",
                "gcp.longrunning.operation_name" = ::tracing::field::Empty
            );
