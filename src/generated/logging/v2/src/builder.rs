...
pub mod config_service_v_2 {
    ...
    impl CreateBucketAsync {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::LogBucket, crate::model::BucketMetadata>
        {
            ...
            let span = ::tracing::info_span!(
                "client::ConfigServiceV2::create_bucket_async.Wait",
                "gcp.rpc.method" = "client::ConfigServiceV2::create_bucket_async.Wait",
    ...
    impl UpdateBucketAsync {
        ...
        ) -> impl google_cloud_lro::Poller<crate::model::LogBucket, crate::model::BucketMetadata>
        {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            let span = ::tracing::info_span!(
                "client::ConfigServiceV2::update_bucket_async.Wait",
                "gcp.rpc.method" = "client::ConfigServiceV2::update_bucket_async.Wait",
                "gcp.longrunning.operation_name" = ::tracing::field::Empty
            );
    ...
    impl CreateLink {
        ...
        pub fn poller(
            ...
            #[cfg(google_cloud_unstable_tracing)]
            let span = ::tracing::info_span!(
                "client::ConfigServiceV2::create_link.Wait",
                "gcp.rpc.method" = "client::ConfigServiceV2::create_link.Wait",
                "gcp.longrunning.operation_name" = ::tracing::field::Empty
            );
    ...
    impl DeleteLink {
        ...
        pub fn poller(self) -> impl google_cloud_lro::Poller<(), crate::model::LinkMetadata> {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            let span = ::tracing::info_span!(
                "client::ConfigServiceV2::delete_link.Wait",
                "gcp.rpc.method" = "client::ConfigServiceV2::delete_link.Wait",
                "gcp.longrunning.operation_name" = ::tracing::field::Empty
            );
    ...
    impl CopyLogEntries {
        ...
        > {
            ...
            #[cfg(google_cloud_unstable_tracing)]
            let span = ::tracing::info_span!(
                "client::ConfigServiceV2::copy_log_entries.Wait",
                "gcp.rpc.method" = "client::ConfigServiceV2::copy_log_entries.Wait",
                "gcp.longrunning.operation_name" = ::tracing::field::Empty
            );
